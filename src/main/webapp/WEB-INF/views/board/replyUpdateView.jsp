	...
	<body id="body">
			...
			<div class="ui middle aligned center aligned grid" >
				<div class="column">
					...
					<table style = "margin-left: auto; margin-right: auto; margin-top:7em;">
						<tbody>
							<tr>
								<td>
					...
					<div style = "margin-top:1em; margin-left:9em ;">
						<button type="submit" class="update_btn ui submit blue button" >저장</button>
						<button type="button" class="cancel_btn ui submit red button">취소</button>
					</div>
					</div>
					</div>
					</form>
