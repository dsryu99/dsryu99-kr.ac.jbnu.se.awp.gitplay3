...
#logoutBtn, #memberUpdateBtn, #login_btn, #boardBtn, #memberdeleteBtn {
	...
	<div class="ui middle aligned center aligned grid">
		...
		<div class="column">
			...
			<form class="ui large form" action="/member/memberDelete" method="post" id="delForm">
				<div class="ui stacked segment">
					...
					<button class="ui fluid large red submit button" type="submit" id="submit">회원탈퇴</button>
					</div>
					</div>
